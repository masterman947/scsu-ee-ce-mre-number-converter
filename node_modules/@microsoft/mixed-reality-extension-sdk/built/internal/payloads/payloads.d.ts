 ...
 * *** KEEP ENTRIES SORTED ***
 */
export declare type PayloadType = Payloads.AssetPayloadType | Payloads.SyncPayloadType | 'actor-correction' | 'actor-update' | 'animation-update' | 'app2engine-rpc' | 'collision-event-raised' | 'create-animation-2' | 'create-empty' | 'create-from-library' | 'destroy-actors' | 'destroy-animations' | 'dialog-response' | 'engine2app-rpc' | 'handshake' | 'handshake-complete' | 'handshake-reply' | 'heartbeat' | 'heartbeat-reply' | 'multi-operation-result' | 'object-spawned' | 'operation-result' | 'perform-action' | 'rigidbody-add-force' | 'rigidbody-add-force-at-position' | 'rigidbody-add-relative-torque' | 'rigidbody-add-torque' | 'rigidbody-commands' | 'rigidbody-move-position' | 'rigidbody-move-rotation' | 'set-authoritative' | 'set-behavior' | 'set-media-state' | 'show-dialog' | 'sync-complete' | 'sync-request' | 'traces' | 'trigger-event-raised' | 'user-joined' | 'user-left' | 'user-update';
/**
 * @hidden
